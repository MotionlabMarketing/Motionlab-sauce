...
<section class="px4 py4" <?php echo (!empty($this->blockConfiguration["location_finder_background_colour"])) ? "style='background-color: {$this->blockConfiguration["location_finder_background_colour"]}'" : ""; ?> <?php echo $this->getAttributeString() ?> data-aos="fade-in">
