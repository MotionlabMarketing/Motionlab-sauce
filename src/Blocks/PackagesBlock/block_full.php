    ...
    <div class="clearfix container">
        ...
        <?php foreach ($packages as $package) : ?>
            <div class="col col-12 md-col-6 p4" data-element="package" data-package-type="<?php echo (isset($package['is_featured']) && $package['is_featured'] == true) ? "featured" : "standard" ?>" data-mh="package">
                <div class="p4 <?php echo (isset($package['background_colour'])) ? $package['background_colour'] : ""; ?>">
                    ...
                    <?php endif; ?>
                    <div>
                        <a href="<?php echo $package['link_location'] ?>" data-element="button" class="button heading-font h3 bg-white hover-white <?php echo str_replace("bg-", "", $package['background_colour']); ?> hover-bg-aqua"><?php echo $package['link_title'] ?></a>
                    </div>
                </div>
            </div>
        <?php endforeach; ?>
