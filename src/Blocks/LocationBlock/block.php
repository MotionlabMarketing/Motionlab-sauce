    ...
    <div class="container xl-flex">
        ...
        <div class="xl-12 xl-col-8 md-flex">
            ...
            <div class="col-12 md-col-6 relative bg-light-grey">
                <iframe width="100%" height="100%" src="https://maps.google.com/maps?width=100%&amp;height=600&amp;hl=en&amp;q=<?php echo urlencode($location['name'] . " " . $location['postcode']); ?>&amp;ie=UTF8&amp;t=&amp;z=14&amp;iwloc=B&amp;output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe></div>
        </div>
