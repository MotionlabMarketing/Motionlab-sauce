...
<section class="<?php echo $this->blockConfiguration['background_colour'] ? $this->blockConfiguration['background_colour']  : ''; ?>" data-aos="fade-in">
    <div class="md-flex">
        <div class="col-12 md-col-6 lg-col-5 flex items-center">
            <div class="p4 lg-p6 <?php echo  $this->blockConfiguration['background_colour'] = 'white' ? '' : 'white'; ?>">
                ...
                <?php if ($this->blockConfiguration['team_page_link']) : ?>
                    <a href="<?php echo $this->blockConfiguration['team_page_link']['url']; ?>" target="<?php echo $this->blockConfiguration['team_page_link']['target']; ?>" class="btn border border-grey grey mx1 uppercase">
