...
class SiteOptions extends Block
{
    ...
    public static $blockAcf = array(
        ...
        'fields' => array(
            ...
            array(
                'key' => 'field_5f6dd0e0f933a',
                'label' => 'Logo (White)',
                'name' => 'header_options_logo_white',
                'type' => 'image',
                'instructions' => '',
                'required' => 0,
                'conditional_logic' => 0,
            ...
            array(
                'key' => 'field_5f6dd0fff933b',
                'label' => 'Logo (Colour)',
                'name' => 'header_options_logo_colour',
                'type' => 'image',
                'instructions' => '',
                'required' => 0,
                'conditional_logic' => 0,
            ...
            array(
                'key' => 'field_5f6dd117f933d',
                'label' => 'Logo (Mobile)',
                'name' => 'header_options_logo_mobile',
                'type' => 'image',
                'instructions' => '',
                'required' => 0,
                'conditional_logic' => 0,
            ...
            array(
                'key' => 'field_5f6dd123f933e',
                'label' => 'Buttons',
                'name' => 'header_options_buttons',
                'type' => 'repeater',
                'instructions' => '',
                'required' => 0,
                'conditional_logic' => 0,
                ...
                'sub_fields' => array(
                    array(
                        'key' => 'field_5f6dd135f933f',
                        'label' => 'Link',
                        'name' => 'header_options_button_link',
                        'type' => 'link',
                        'instructions' => '',
                        'required' => 0,
                        'conditional_logic' => 0,
            ...
            array(
                'key' => 'field_5f6dd17df9341',
                'label' => 'Company Registration Details',
                'name' => 'footer_options_registration_details',
                'type' => 'wysiwyg',
                'instructions' => 'This field represents the business registration line that appears below the footer.',
                'required' => 0,
                'conditional_logic' => 0,
                'wrapper' => array(
                    'width' => '',
            ...
            array(
                'key' => 'field_5f6dd1bff9342',
                'label' => 'Logo (Footer)',
                'name' => 'footer_options_logo',
                'type' => 'image',
                'instructions' => '',
                'required' => 0,
                'conditional_logic' => 0,
            ...
            array(
                'key' => 'field_9eba3b42e18c0b',
                'label' => 'Sticky Link',
                'name' => 'footer_options_sticky_link',
                'type' => 'link',
                'instructions' => '',
                'required' => 0,
                'conditional_logic' => 0,
