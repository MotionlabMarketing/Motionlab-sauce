...
<section class="slider-tabs-block bg-light-grey <?php echo ($this->blockConfiguration["full_width"]) ? "" : "container"; ?>" data-block-name="slider-tabs-block" <?php echo $this->getAttributeString() ?> data-aos="fade-in">
                                            ...
                                            <div class="col col-12 lg-col-6 <?php echo ($key === 0) ? "md-mb0" : ""; ?>">
                                                <a href="<?php echo $ctaUrl; ?>" title="<?php echo $ctaTitle; ?>" class="block hover-bg-white p2 md-p3 rounded">
                                                    <div class="flex items-center">
                                                        ...
                                                        <i class="ml2 mt1 fas fa-arrow-alt-circle-right dark-purple" aria-hidden="true"></i>
                                                    </div>
