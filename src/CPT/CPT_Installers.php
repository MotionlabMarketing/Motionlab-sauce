...
class CPT_Installers
{

    // Set CPT options.
    private $name       = "Installers"; // Name of the CPT on Registration
    private $group      = "Installers";
    private $singular   = "Installer";
    private $plural     = "Installers";
    ...
    public function registerSingleTemplate($single) {
        ...
        if($post->post_type == strtolower(str_replace(' ', '', $this->name))) {
            return __DIR__ . "/single-installer.php";
        }
