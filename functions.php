 ...
 * @author Joseph Curran <hello@joecurran.codes>
 *
 * return $output
 */
 function pa()
...
add_action('after_setup_theme', 'together_dental_setup');
...
{
    $post = get_post();
    $excerpt .= '<a href="'. get_permalink($post->ID) . '" class="bold secondary hover-primary">Continue reading...</a>';
    return $excerpt;
}
